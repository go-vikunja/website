...
If your proxy needs a username and password, put them in the URL as shown above. If you use [mole](https://github.com/frain-dev/mole), you can instead set `outgoingrequests.proxypassword`. Vikunja then authenticates with the username `vikunja`.
