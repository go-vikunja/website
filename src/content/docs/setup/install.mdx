...
[PikaPods](https://www.pikapods.com/pods?run=vikunja) also offers one-click managed hosting for Vikunja, with updates and backups taken care of for you.

[![Run on PikaPods](../../../assets/images/docs/run-on-pikapods.svg)](https://www.pikapods.com/pods?run=vikunja)
