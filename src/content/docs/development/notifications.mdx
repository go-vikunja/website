...
slug: notifications
description: >-
  Learn how to implement and send notifications in Vikunja, including mail and
  database notifications, creating custom notifications, and testing best
  practices.
---
...
If not provided, the `from` field of the mail contains the value configured in [`mailer.fromemail`](https://vikunja.io/docs/config-options#1-mailer-fromemail).
...
This prevents any notifications from being sent and lets you assert a notification has been sent like this:
...
Take a look at the [pkg/user/notifications.go](https://github.com/go-vikunja/vikunja/blob/main/pkg/user/notifications.go) file for a good example.
