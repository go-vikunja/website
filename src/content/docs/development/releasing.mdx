...
description: >-
  Comprehensive release checklist for Vikunja: Website updates, changelogs,
  tagging, package updates, blog posts, and promotion across platforms.
---
...
* Tag a new version: Run `mage dev:tag-release <version>` (e.g. `mage dev:tag-release v1.0.0`). This will:
	* Update the version badge in README.md
	* Generate the changelog using git-cliff
	* Clean up and prepend the changelog to CHANGELOG.md
	* Commit the changes with message `chore: <version> release preparations`
...
* Update external packages:
	* [Flathub desktop package](https://github.com/flathub/io.vikunja.Vikunja)
	* Nixos
	* Coopcloud
