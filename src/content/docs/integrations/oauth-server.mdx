...
All errors are returned as HTTP 400 responses with a JSON body containing a `code` field. See the [OAuth section of the error codes reference](/docs/errors/#oauth) for the full list.
