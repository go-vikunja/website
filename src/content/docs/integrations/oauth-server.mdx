...
See [RFC 7636 Section 4.1](https://datatracker.ietf.org/doc/html/rfc7636#section-4.1) and [Section 4.2](https://datatracker.ietf.org/doc/html/rfc7636#section-4.2) for the full specification.

## Error codes

All errors are returned as HTTP 400 responses with a JSON body containing a `code` field. See the [OAuth section of the error codes reference](/integrations/errors/#oauth) for the full list.
