...
<Screenshot src="projects-overview" alt="Project overview page showing all projects" />

## Project settings

To open project settings, click the **three-dot menu** next to the project title and select **Edit**.

<Screenshot src="projects-context-menu" alt="Project context menu with available actions" />

<Screenshot src="projects-settings-form" alt="Project settings form" />
...
<Screenshot src="projects-background-dialog" alt="Background image dialog with upload and Unsplash options" />
...
<Screenshot src="projects-favorite-icon" alt="Star icon for favoriting a project" />
