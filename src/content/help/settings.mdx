...
![Settings entry point in the user menu](../../assets/images/help/settings-entry-point.png)
...
![General settings tab](../../assets/images/help/settings-general.png)
...
![Avatar options including initials, Gravatar, marble, and upload](../../assets/images/help/settings-avatar-options.png)
...
This tab shows the CalDAV details you need to connect external calendar or task apps to Vikunja.

See [CalDAV](/help/caldav) for full details on supported properties, URLs, and client compatibility.
...
![Delete account section at the bottom of settings](../../assets/images/help/settings-delete-account.png)
