...
<Screenshot src="saved-filters-create-form" alt="Saved filter creation form with title, description, and filter query" />
...
<Screenshot src="saved-filters-sidebar" alt="Saved filters shown in the left sidebar" />
