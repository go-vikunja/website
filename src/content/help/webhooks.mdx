...
<Screenshot src="webhooks-settings-section" alt="Webhooks section in project settings" />

1. Open the [project](/help/projects) where you want the webhook.
2. Go to the project settings and select **Webhooks**.
<Screenshot src="webhooks-create-form" alt="Webhook creation form with URL, events, and secret fields" />
