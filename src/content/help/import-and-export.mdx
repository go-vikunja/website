...
Everything lands under a project called **Migrated from Planka**. A Planka project with a single board becomes one Vikunja project; a project with several boards becomes a parent project with one child project per board. Lists become kanban buckets, cards become tasks, and labels, due dates, comments, attachments, and cover images are preserved.

Cards in a closed or archive list are imported as done; the trash list is skipped. Checklists, custom fields, and link attachments are added to the task description. Comments keep the author's name but not their account. Assignees and board members are not imported.
