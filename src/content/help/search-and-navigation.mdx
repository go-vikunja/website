...
<Screenshot src="search-global-dialog" alt="Global search dialog with results" />
...
<Screenshot src="search-quick-actions" alt="Quick actions menu for creating tasks, projects, and teams" />
...
<Screenshot src="navigation-keyboard-shortcuts" alt="Keyboard shortcuts overlay" />
...
<Screenshot src="navigation-notifications" alt="Notifications panel showing recent updates" />
