...
description: >-
  Find tasks and projects with global search, keyboard shortcuts, and
  notifications.
---
...
![Global search dialog with results](../../assets/images/help/search-global-dialog.png)
...
You can narrow results by typing prefixes for projects, labels, assignees, or priorities directly into the search box. The prefixes depend on your [Quick Add Magic mode](/help/settings#quick-add-magic-mode):
...
![Quick actions menu for creating tasks, projects, and teams](../../assets/images/help/search-quick-actions.png)

From the search dialog, you can also:

- Create a new [task](/help/tasks)
- Create a new [project](/help/projects)
- Create a new [team](/help/sharing-and-teams)
...
![Keyboard shortcuts overlay](../../assets/images/help/navigation-keyboard-shortcuts.png)
...
![Notifications panel showing recent updates](../../assets/images/help/navigation-notifications.png)
...
- **A [reminder](/help/dates-and-reminders) triggers** that you previously set on a task.

### Subscribing to Tasks and Projects

You can [subscribe to tasks](/help/tasks#subscribing-to-a-task) or entire [projects](/help/projects) if you want updates even when work is not directly assigned to you.
