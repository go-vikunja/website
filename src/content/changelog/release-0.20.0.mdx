...
description: >-
  Discover Vikunja 0.20.0: The open-source to-do app with new features like
  Gantt chart improvements, enhanced link shares, and task cover images. 
---
...
### Subtasks on indentation

When creating multiple tasks at once through the multiline input in the list view you can now use indentation to indicate subtasks.
...
You can now promote an attachment to a task cover image!
