...
I've prepared a short survey to allow me to better understand the needs of you, the users.
...
Vikunja instances, for example from [a hosted offering](https://app.vikunja.cloud/?redirectToProvider=true) to self-hosted and vice-versa.
