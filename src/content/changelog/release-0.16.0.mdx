...
description: >-
  Discover new features in Vikunja 0.16.0: desktop app, enhanced filters,
  Microsoft To-Do and Trello migration, email reminders, and more. Upgrade now!
---
...
![More filter options](../../assets/images/changelog/0.16.0-more-filters.png)
...
![Migration options](../../assets/images/changelog/0.16.0-migration-microsoft-to-do-trello.png)
...
If you add a reminder to a task, Vikunja can now send you an email when it's due to, well, remind you of it.
