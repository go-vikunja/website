...
Vikunja has let you view your tasks in list, gantt, table and kanban views for a while now.
...
The Vikunja web UI is now available in Brazilian Portuguese, Croatian and Ukrainian languages.
