...
description: >-
  Vikunja 0.21.0 release: Lists and Namespaces become Projects, relative
  reminders added, improved assignee search, and frontend settings enhancements.
---
...
With this release, we rename lists to projects to better represent what they are actually used for and remove the concept of a namespace altogether.
...
![Relative Reminders](../../assets/images/changelog/0.21.0-relative-reminders.png)
...
![Assignee Search](../../assets/images/changelog/0.21.0-assignees.png)
