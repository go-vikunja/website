...
description: >-
  Vikunja 0.20.4 patch release: Key fixes for frontend and API, improved Docker
  images, migration updates, and new official Helm Chart for k8s deployment.
---
...
If you're running (or want to) Vikunja in a k8s environment, we highly recommend using this chart.
