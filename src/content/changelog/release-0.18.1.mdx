...
description: >-
  Vikunja patch release v0.18.1 fixes user data export, kanban board, and
  repeating tasks issues. Update API, frontend, and desktop components easily.
---
...
You can also check out the docs [for the api](https://vikunja.io/docs/installing/#updating) or [frontend](https://vikunja.io/docs/installing/#updating) updating process.
