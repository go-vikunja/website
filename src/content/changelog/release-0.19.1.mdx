...
description: >-
  Vikunja v0.19.1 patch release: UI improvements, API fixes, and Docker support
  for Raspberry Pi. Includes breaking change for assignee filtering.
---
...
It also provides docker images for arm 32 (Raspberry Pi) and fixes a problem generating blur hashes for list backgrounds in certain formats.
...
This was necessary to be able show the users with their name when re-opening a saved filter.
