...
description: >-
  ...
  filtering, and task sorting. Includes frontend and API improvements.
---
...
* More components and internals have been migrated to the new VueJS script setup syntax.
