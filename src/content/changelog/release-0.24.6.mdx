---
title: 'Vikunja 0.24.6: Security fix (again)'
date: 2024-12-22T22:00:00.000Z
isRelease: true
slug: /vikunja-v0.24.6-was-released
description: >-
  Vikunja 0.24.6 update: one important security fix.
---

This release contains one important security fix which allowed accessing other user's task data.

Please update as soon as possible, especially if you have multiple users on your instance.

The details will be disclosed at a later date.
