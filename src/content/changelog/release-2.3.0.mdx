...
**WeKan** boards can now be imported directly by uploading the board's JSON export. Tasks, labels, and buckets all come across in one go. There's a WeKan entry on the migration page and a dedicated logo to go with it. Contributed in [#2548](https://github.com/go-vikunja/vikunja/pull/2548).
