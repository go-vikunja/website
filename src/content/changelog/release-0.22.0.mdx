...
description: >-
  Vikunja 0.22.0 release: New features include API tokens, webhooks, n8n
  integration, improved editor, and Typesense search support for the open-source
  to-do app.
---
...
* **Metrics:** The prometheus endpoint now returns information about the number of files, attachments and active link shares.
